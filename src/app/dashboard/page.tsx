    ...
    >
      <MobileContainer>
        <MobileSpacing size="md">
          ...
          <div className="mt-8 p-4 sm:p-6 rounded-lg bg-gradient-to-r from-blue-400/10 to-purple-400/10 border border-blue-400/20">
            <div className="max-w-3xl">
              <h2 className="text-xl font-semibold text-foreground mb-2">
                Welcome to Your Wellness Journey! 🌟
              </h2>
              <p className="text-muted-foreground mb-4">
                Your dashboard is your command center for building healthy
                habits. Here you can track your daily reminders, monitor your
                progress, and take quick actions to stay on top of your wellness
                goals.
              </p>
